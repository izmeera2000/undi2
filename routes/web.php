...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/notifications/read-all', [NotificationController::class, 'markAllAsRead'])->name('notifications.allread');
    Route::post('/notifications/mark-selected', [NotificationController::class, 'markSelected'])->name('notifications.markSelected');
});
