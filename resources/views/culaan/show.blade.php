                ...
                <form id="addPengundiForm">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <label>No Siri</label>
                                <input type="text" name="no_siri" class="form-control" placeholder="No Siri">
                            </div>

                            <div class="col-md-3">
                                <label>Saluran</label>
                                <input type="text" name="saluran" class="form-control" placeholder="Saluran">
                            </div>
                            ...
                            <div class="col-md-3">
                                <label>No KP</label>
                                <input type="text" name="no_kp" class="form-control" placeholder="No KP" required>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label>Bangsa</label>
                                <input type="text" name="bangsa" class="form-control" placeholder="Bangsa">
                            </div>

                            <div class="col-md-3">
                                <label>Kategori Pengundi</label>
                                <input type="text" name="kategori_pengundi" class="form-control"
                                    placeholder="Kategori Pengundi">
                            </div>
                            ...
                            <div class="col-md-3">
                                <label>Status</label>
                                <input type="text" name="status_ahli" class="form-control" placeholder="Status Ahli">
                            </div>

                            <div class="col-md-3">
                                <label>Kategori</label>
                                <input type="text" name="kategori_ahli" class="form-control" placeholder="Kategori Ahli">
                            </div>
